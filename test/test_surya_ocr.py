...
def test_surya_ocr(image_path):
    print(f"\n{'='*80}\nTesting SuryaOCR on: {os.path.basename(image_path)}\n{'='*80}")
    
    # Use OCRMethods class method instead of direct implementation
    raw_text = OCRMethods.extract_with_suryaocr(image_path)
    print("\nRaw Extracted Text:")
